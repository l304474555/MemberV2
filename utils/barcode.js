...
exports.code128 = function (ctx, text, width, height, onDrawed) {
    ...
    ctx.draw(false, function(e){
      console.log('条码回调', e, e.errMsg);
      if (typeof onDrawed == 'function' && typeof e != 'undefined'){
        var success = e.errMsg == "drawCanvas:ok";
        onDrawed(success, e);
      }
    });
}
